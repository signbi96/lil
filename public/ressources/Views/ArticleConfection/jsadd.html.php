            <div class="menu" style="width:100%;background:#002978;height:5em">
                                  ...
                                  <div class="row">
                                          ...
                                          <div class="col md-6">
                                             <div class="form-group has-success" id="image" style="width:80%;margin-left:10%" >
                                               <input type="file" name="photo" value="" class="form-control" id="inputvalid" style="display:none;">
                            ...
                            <div class="modal-dialog">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                 ...
                                 <div class="convertir" style="display:flex;justify-content:space-aaround" >
                                 ...
                                 <input type="text" name="enMetre" id="enMetre" class="form-control" value=""> 
                                 <button type="button" class="btn btn-primary" id="ok" style="background:#002978">ok</button>
                                 </div>
                                 <table class="table table-bordered" style="margin-top:1%">
                                        <thead style="background:#002978;color:white">
                                          <tr style="height:3em">
                                            <th>id</th>
                                            <th>libelleUnite</th>
                                            <th>convertisseur</th>
