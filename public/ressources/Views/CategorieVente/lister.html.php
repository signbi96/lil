            ...
            <div class="contenu" style='width:80%; height:auto; float: right;'>
                     <h4 class="liste" style="margin-left:30%;margin-top:4%">La liste des categories de vente</h4>
                                         ...
                                         <?php for($i=1;$i<=$nombrepage;$i++):?>  
                                          ...
                                          <?php if($i == $page):?>
                                            ...
                                            <li class="page-item disabled">
                                              <a class="page-link" href="<?= WEB_ROUTE.'?path=categorie_vente&page='.$i?>"><?= $i ;?></a>
                                            </li>                          
                    
                                            <?php else:?>
                                              <li class="page-item active">
                                              <a class="page-link" style="background: #002879;" href="<?= WEB_ROUTE.'?path=categorie_vente&page='.$i?>"><?= $i ;?></a>
                                            </li>
