                                         ...
                                         <?php for($i=1;$i<=$nombrepage;$i++):?>  
                                          ...
                                          <?php if($i == $page):?>
                                            ...
                                            <li class="page-item disabled">
                                              <a class="page-link" href="<?= WEB_ROUTE.'?path=articleVente-detail&page='.$i?>"><?= $i ;?></a>
                                            </li>                          
                    
                                            <?php else:?>
                                              <li class="page-item active">
                                              <a class="page-link" style="background: #002879;" href="<?= WEB_ROUTE.'?path=articleVente-detail&page='.$i?>"><?= $i ;?></a>
                                            </li>
